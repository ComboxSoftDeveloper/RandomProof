...
; RandomProof.Benchmarks.CreateBench.WithoutSeed()
       jmp       qword ptr [7FFDF2A4F858]; RandomProof.Subjects.CreateWithoutSeed()
...
; RandomProof.Subjects.CreateWithoutSeed()
       ...
       mov       rsi,rax
       mov       rcx,rsi
       call      qword ptr [7FFDF2A4F990]; System.Random+XoshiroImpl..ctor()
       lea       rcx,[rbx+8]
       mov       rdx,rsi
...
; RandomProof.Benchmarks.CreateBench.WithSeed()
       jmp       qword ptr [7FFDF2A3F858]; RandomProof.Subjects.CreateWithSeed()
; Total bytes of code 6
```
```assembly
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithoutSeed()
       jmp       qword ptr [7FFDC8E4E178]; RandomProof.Subjects.CreateWithoutSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithoutSeed()
       ...
       mov       rbx,rax
       mov       rcx,rbx
       call      qword ptr [7FFDC8C3E658]; System.Random..ctor()
       mov       rax,rbx
       add       rsp,20
       pop       rbx
       ret
...
; System.Random..ctor()
       ...
       mov       rdi,rax
       mov       rcx,rdi
       call      qword ptr [7FFDC8E4E1A8]; System.Random+XoshiroImpl..ctor()
M02_L00:
       lea       rcx,[rbx+8]
       mov       rdx,rdi
       call      CORINFO_HELP_ASSIGN_REF
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithSeed()
       jmp       qword ptr [7FFDC8E5E9A0]; RandomProof.Subjects.CreateWithSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithSeed()
       ...
       jne       short M01_L00
       mov       edx,2A
       call      qword ptr [7FFDC8DADD40]; System.Random+CompatPrng.Initialize(Int32)
M01_L00:
       mov       rdx,rsi
       lea       rcx,[rbx+8]
       call      CORINFO_HELP_ASSIGN_REF
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithoutSeed()
       jmp       qword ptr [7FFDB57DEAF0]; RandomProof.Subjects.CreateWithoutSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithoutSeed()
       ...
       mov       rbx,rax
       mov       rcx,rbx
       call      qword ptr [7FFDB57DEB08]; System.Random..ctor()
       mov       rax,rbx
       add       rsp,20
       pop       rbx
       ret
...
; System.Random..ctor()
       ...
       mov       rsi,rax
       mov       rcx,rsi
       call      qword ptr [7FFDB57DEC28]; System.Random+XoshiroImpl..ctor()
M02_L00:
       lea       rcx,[rbx+8]
       mov       rdx,rsi
       call      CORINFO_HELP_ASSIGN_REF
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithSeed()
       jmp       qword ptr [7FFDB57EEBB0]; RandomProof.Subjects.CreateWithSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithSeed()
       ...
       jne       short M01_L00
       mov       edx,2A
       call      qword ptr [7FFDB57E4BD0]; System.Random+CompatPrng.Initialize(Int32)
M01_L00:
       mov       rdx,rsi
       lea       rcx,[rbx+8]
       call      CORINFO_HELP_ASSIGN_REF
