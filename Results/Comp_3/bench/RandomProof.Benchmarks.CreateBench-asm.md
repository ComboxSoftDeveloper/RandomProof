...
; RandomProof.Benchmarks.CreateBench.WithoutSeed()
       jmp       qword ptr [7FFEAFC8FB70]; RandomProof.Subjects.CreateWithoutSeed()
...
; RandomProof.Subjects.CreateWithoutSeed()
       ...
       mov       rsi,rax
       mov       rcx,rsi
       call      qword ptr [7FFEAFC8FCA8]; System.Random+XoshiroImpl..ctor()
       lea       rcx,[rbx+8]
       mov       rdx,rsi
...
; RandomProof.Benchmarks.CreateBench.WithSeed()
       jmp       qword ptr [7FFEAFC5FB88]; RandomProof.Subjects.CreateWithSeed()
; Total bytes of code 6
```
```assembly
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithoutSeed()
       jmp       qword ptr [7FFE6B25E988]; RandomProof.Subjects.CreateWithoutSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithoutSeed()
       ...
       mov       rbx,rax
       mov       rcx,rbx
       call      qword ptr [7FFE6B04E658]; System.Random..ctor()
       mov       rax,rbx
       add       rsp,20
       pop       rbx
       ret
...
; System.Random..ctor()
       ...
       mov       rdi,rax
       mov       rcx,rdi
       call      qword ptr [7FFE6B25E9B8]; System.Random+XoshiroImpl..ctor()
M02_L00:
       lea       rcx,[rbx+8]
       mov       rdx,rdi
       call      CORINFO_HELP_ASSIGN_REF
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithSeed()
       jmp       qword ptr [7FFE6B24E9A0]; RandomProof.Subjects.CreateWithSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithSeed()
       ...
       jne       short M01_L00
       mov       edx,2A
       call      qword ptr [7FFE6B19DD40]; System.Random+CompatPrng.Initialize(Int32)
M01_L00:
       mov       rdx,rsi
       lea       rcx,[rbx+8]
       call      CORINFO_HELP_ASSIGN_REF
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithoutSeed()
       jmp       qword ptr [7FFE6B13EB50]; RandomProof.Subjects.CreateWithoutSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithoutSeed()
       ...
       mov       rbx,rax
       mov       rcx,rbx
       call      qword ptr [7FFE6B13EB68]; System.Random..ctor()
       mov       rax,rbx
       add       rsp,20
       pop       rbx
       ret
...
; System.Random..ctor()
       ...
       mov       rsi,rax
       mov       rcx,rsi
       call      qword ptr [7FFE6B13EC88]; System.Random+XoshiroImpl..ctor()
M02_L00:
       lea       rcx,[rbx+8]
       mov       rdx,rsi
       call      CORINFO_HELP_ASSIGN_REF
...
```assembly
; RandomProof.Benchmarks.CreateBench.WithSeed()
       jmp       qword ptr [7FFE6B16EB38]; RandomProof.Subjects.CreateWithSeed()
; Total bytes of code 6
```
```assembly
; RandomProof.Subjects.CreateWithSeed()
       ...
       jne       short M01_L00
       mov       edx,2A
       call      qword ptr [7FFE6B164B58]; System.Random+CompatPrng.Initialize(Int32)
M01_L00:
       mov       rdx,rsi
       lea       rcx,[rbx+8]
       call      CORINFO_HELP_ASSIGN_REF
